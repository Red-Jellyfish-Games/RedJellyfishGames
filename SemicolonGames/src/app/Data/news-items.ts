export const NewsItemsList = [{
    ...
    content: 'The website is currently under construction.',
    date: new Date(2019, 12, 31)
},
{
    title: 'Website published',
    content: 'This is the website for Red Jellyfish games. I hope this is a website you"ll visit more often. Please explore the website and give feedbback if you find something odd. ',
